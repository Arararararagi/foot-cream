...
function FootFree._classify_prime(s)
    ...
    if ends_any(tail, SGL) then return 3 end          -- 6′
    if dbl then return 4 end                          -- 3″
    return nil
end
